...
export const revalidate = 0; // This will disable caching
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const firstProduct = productsData.data[0]; // Get first product for default metadata
          ...
          <div className="mt-10">
            {categoriesData.data?.map((category) => (
              <div key={category.id} id={`category-${category.id}`} className="mb-16 scroll-mt-24">
                {/* Add meta tags for each category section */}
